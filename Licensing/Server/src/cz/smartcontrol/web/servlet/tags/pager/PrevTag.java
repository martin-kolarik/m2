 ...
 * @author Martin
 */
public class PrevTag extends Common {
...
//-----------------------------------------------------------------------------
    ...
    public int doStartTag() throws JspTagException {
        ...
        if( uriId != null ) {
            pageContext.setAttribute( uriId, getUri( prevPage ));
        }
        if( pageNumberId != null ) {
            pageContext.setAttribute( pageNumberId, new Integer( prevPage ));
        }
        if( activeId != null ) {
            pageContext.setAttribute( activeId, new Boolean( currentPage > prevPage ));
        }
