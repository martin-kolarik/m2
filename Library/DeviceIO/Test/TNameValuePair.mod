...
(*---------------------------------------------------------------------------*)
   ...
   BEGIN
      ...
      iv.String := is;
      Failure := NOT nvp.DefineStorageValue( s, iovalue.vtString, iovalue.flagsDefaultSWRO, ADR( iv ), ADR( s ), NIL, OUT children ) OR Failure;
      Failure := nvp.DefineStorageValue( s, iovalue.vtString, iovalue.flagsDefaultSWRO, ADR( iv ), ADR( s ), NIL, OUT children ) OR Failure;

      s.FromOA( L"Member" );
      iv.Long := 2;
      Failure := NOT nvp.DefineStorageValue( s, iovalue.vtLong, iovalue.flagsDefaultSWRW, ADR( iv ), ADR( s ), NIL, OUT children ) OR Failure;
      Failure := nvp.DefineStorageValue( s, iovalue.vtString, iovalue.flagsDefaultSWRW, ADR( iv ), ADR( s ), NIL, OUT children ) OR Failure;

      s.FromOA( L"ArrayOfValues" );
      Failure := NOT nvp.DefineStorageValue( s, iovalue.vtObject, iovalue.flagsDefaultObject, NIL, ADR( s ), NIL, OUT children ) OR Failure;
      Failure := nvp.DefineStorageValue( s, iovalue.vtString, iovalue.flagsDefaultSWRW, NIL, ADR( s ), NIL, OUT children ) OR Failure;
      //---
      s.FromOA( L"0" );
      iv.Integer := 0;
