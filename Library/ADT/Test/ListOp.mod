...
VAR
  ...
  b : BOOLEAN;
BEGIN
  NEW( E1 ); E1^.I := 3; L.Append( E1 );
  NEW( E1 ); E1^.I := 4; L.Append( E1 );
  NEW( E1 ); E1^.I := 5; L.Append( E1 );
  NEW( E1 ); E1^.I := 7; L.Append( E1 ); E3 := E1;
  NEW( E1 ); E1^.I := 8; L.Append( E1 );
  NEW( E1 ); E1^.I := 9; L.Append( E1 );
  ...
  WHILE b DO
    IF E1^.I MOD 2 = 0 THEN
      b := L.NextOf( E1, OUT E2 );
      L.Delete( E1 );
      E1 := E2;
    ELSE
      b := L.NextOf( E1, OUT E1 );
    END;
  END;
END ListTest;
