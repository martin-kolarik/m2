...
(*---------------------------------------------------------------------------*)
   ...
   BEGIN
      ...
      Logger.LogS( log.dldMessage, 0, L"Integra", L"Started" );
...
(*---------------------------------------------------------------------------*)
   ...
   BEGIN
      ...
      Connection.Close();
      Logger.LogS( log.dldMessage, 0, L"Integra", L"Stopped" );
   END Stop;
...
(*---------------------------------------------------------------------------*)
   ...
   VAR
      ...
      BEGIN
         ...
         END;
         Log^.LogFilePos( log.lcError, 0, L"Integra", L"", OA( msg.Length-1, msg.rawData ), line, 0 );
      END LogError;
